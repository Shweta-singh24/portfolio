...
const Contact = () => {
  return (
    <section id="contact" className="py-20 px-6 md:px-20 bg-gray-200">
      ...
      <div className="max-w-2xl mx-auto">
        <form className="flex flex-col gap-6">
          ...
          <button type="submit" className="bg-gray-800 text-white font-semibold p-4 rounded-lg hover:bg-gray-900 transition">Send Message</button>
        </form>
        <p className="text-center mt-6 text-black">Or email me at: shwetasingh02415@gmail.com</p>
      </div>
    </section>
  );
};
